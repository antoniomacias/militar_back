...
public class ZTM_CATEGORIA {
    ...
    public ZTM_CATEGORIA(int idcategoria, String nombre, float tiempo_pregunta, String usuario_creacion,
    ...
    public float getTiempo_pregunta() {
        return tiempo_pregunta;
    }
    public void setTiempo_pregunta(float tiempo_pregunta) {
        this.tiempo_pregunta = tiempo_pregunta;
    }
