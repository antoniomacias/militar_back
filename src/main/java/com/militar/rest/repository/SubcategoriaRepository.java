...
public interface SubcategoriaRepository extends JpaRepository<ZTM_SUBCATEGORIA, Integer> {
    ...
    @Query("SELECT p.idsubcategoria, p.idcategoria, p.nombre, p.usuario_creacion, p.fecha_creacion, p.usuario_modificacion, p.fecha_modificacion FROM ZTM_SUBCATEGORIA p ")
